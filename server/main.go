...
func (c *GitHubClient) request(path string) ([]byte, int, error) {
	...
	req.Header.Set("User-Agent", "RepoAnalyst-App")
...
var allowedOrigins = map[string]bool{
	...
	"https://repoanalyst.vercel.app":  true,
...
func generatePDF(w http.ResponseWriter, r *http.Request) {
	...
	pdf.Text(15, pageHeight-6, "Generated by RepoAnalyst")
...
func generateCSV(w http.ResponseWriter, r *http.Request) {
	...
	if analysis == nil {
		...
		w.Header().Set("Content-Disposition", "attachment; filename=repoanalyst.csv")
		w.Write([]byte(csv))
		return
	}
...
func main() {
	...
	fmt.Println("🚀 RepoAnalyst API Server (Real Analysis)")
